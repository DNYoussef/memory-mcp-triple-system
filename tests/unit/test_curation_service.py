...
class TestCurationServiceInitialization:
    ...
    def test_initialization_with_existing_collection(
        self, mock_chroma_client, tmp_path
    ):
    ...
    def test_initialization_requires_chroma_client(self, tmp_path):
        ...
        with pytest.raises(ValueError):
            CurationService(chroma_client=None, data_dir=str(tmp_path))
...
class TestPreferences:
    ...
    def test_save_preferences_validates_required_fields(self, service):
        ...
        incomplete_prefs = {"user_id": "default", "time_budget_minutes": 10}

...
class TestGetParallelTestCommand:
    ...
    def test_with_specific_test_files(self):
        ...
        cmd = get_parallel_test_command(
            test_files=["test_a.py", "test_b.py"], project_root="/path/to/project"
        )
    ...
    def test_without_test_files(self):
        ...
        cmd = get_parallel_test_command(test_files=[], project_root="/path/to/project")
    ...
    def test_custom_workers(self):
        ...
        cmd = get_parallel_test_command(
            test_files=["test.py"], project_root="/path/to/project", workers="4"
        )
    ...
    def test_includes_project_root(self):
        ...
        cmd = get_parallel_test_command(
            test_files=["test.py"], project_root="/my/project"
        )
